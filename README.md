...
```
- You install the dependencies ```npm install```
- If 'canvas' brings an error, please follow the instructions in [https://www.npmjs.com/package/canvas](https://www.npmjs.com/package/canvas). 
TLDR; Run the command ```sudo apt-get install build-essential libcairo2-dev libpango1.0-dev libjpeg-dev libgif-dev librsvg2-dev``` and then ```npm install --build-from-source```
