...
module.exports = function ConvertToEmoji(number) {
	...
	case '36':
		...
		break;
	case 'fg':
		emoji = '<:green_fruit:344561665364328452>';
		break;
	case 'fr':
		emoji = '<:red_fruit:344561665448214539>';
		break;
	case 'fw':
		emoji = '<:white_fruit:344561665326710784>';
		break;
	case 'fo':
		emoji = '<:orange_fruit:344561665389363210>';
		break;
	case 'fp':
		emoji = '<:purple_fruit:344561665146224640>';
		break;
	case 'fy':
		emoji = '<:yellow_fruit:344561665398013952>';
		break;
	case 'fb':
		emoji = '<:blue_fruit:344561664034603009>';
		break;
	case 'e':
