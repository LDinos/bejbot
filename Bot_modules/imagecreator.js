...
async function create_board_image(board_arr) {
	let maxwidth = 0;
	...
	const b64 = await mergeImages(image_arr, { Canvas: Canvas, Image: Image, width : maxwidth * 64, height : maxheight * 64 });
...
module.exports = { create_board_image };